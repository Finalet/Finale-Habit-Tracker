...
func addGravityAnimation(to layer: CALayer) {
    ...
    animation.values = [0, 100, 1000, 2000]
...
func createConfettiLayer() -> CAEmitterLayer {
   let emitterLayer = CAEmitterLayer()
    ...
    emitterLayer.emitterPosition = CGPoint(x: UIViewController().view.bounds.midX, y: UIViewController().view.bounds.maxY + 100)
    emitterLayer.emitterSize = CGSize(width: 100, height: 100)
    emitterLayer.emitterShape = .sphere
    emitterLayer.frame = UIViewController().view.bounds
